...
sudo apt install mariadb-server php-gd php-mysql php-curl php-mbstring php-intl php-gmp php-bcmath php-xml php-imagick libmagickcore-7.q16-10-extra php-zip php-bz2 php-fpm php-redis php-apcu php-memcache unzip vim
```
